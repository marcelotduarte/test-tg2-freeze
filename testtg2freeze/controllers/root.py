...
from testtg2freeze import model
from testtg2freeze.controllers.secure import SecureController
from testtg2freeze.model import DBSession
from tgext.admin.tgadminconfig import BootstrapTGAdminConfig as TGAdminConfig
from tgext.admin.controller import AdminController

from testtg2freeze.lib.base import BaseController
from testtg2freeze.controllers.error import ErrorController
...
class RootController(BaseController):
    """
    The root controller for the test-tg2-freeze application.
    ...
    def _before(self, *args, **kw):
        tmpl_context.project_name = "testtg2freeze"

    @expose('testtg2freeze.templates.index')
    def index(self):
        """Handle the front-page."""
        return dict(page='index')

    @expose('testtg2freeze.templates.about')
    def about(self):
        """Handle the 'about' page."""
        return dict(page='about')

    @expose('testtg2freeze.templates.environ')
    def environ(self):
    ...
    @expose('testtg2freeze.templates.login')
